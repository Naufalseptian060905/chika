...
module.exports.help = { //remove this entire thing if you dont have a commandhandler
  name: "nuke",
  description: "untuk menuke channel"
};

module.exports.run = async (client, message, args) => { // replace with "client.on("message", async (message) => {" without the quotation marks
